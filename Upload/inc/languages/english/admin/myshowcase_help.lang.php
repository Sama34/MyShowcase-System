...
<li><strong>Relative Path from Forum:</strong> is the path from the MyBB root folder to the Main File. This allows the showcase main file to be located outside the MyBB root folder and still be linked inside MyBB posts and portal. If you setup the Main File to be located outside the MyBB root folder, you must edit the Main File directly and specify the relative path to the forums. Any required edits are commented as such in the file.
</ul>
...
<li><strong>Main File:</strong> This is the PHP file to be used for the showcase. There should be no path information here, file_name only.
<li><strong>Folder to Store Attachments:</strong> This is the location on the server that will be used to store attachments for the showcase. This should be relative to the Main File and must be writable by the webserver.
...
<li><strong>Path to Forums:</strong> This is the relative path from the Forum Index to the Main File. This is used when 'Link this showcase in user details in posts' option is enabled.
