...
$l = array_merge([
    ...
    'myShowcaseAdminSummaryAddEditMainName' => 'Name',
    'myShowcaseAdminSummaryAddEditMainNameDescription' => 'This is the name used in links and titles of the showcase.',
    'myShowcaseAdminSummaryAddEditMainShowcaseSlug' => 'Slug',
    'myShowcaseAdminSummaryAddEditMainShowcaseSlugDescription' => 'Showcase slug that is used with this specific showcase.',
    'myShowcaseAdminSummaryAddEditMainDescription' => 'Description',
    'myShowcaseAdminSummaryAddEditMainDescriptionDescription' => 'Simple description of the showcase. Not used externally, for admin use only.',
    'myShowcaseAdminSummaryAddEditMainScriptName' => 'Script Name',
    'myShowcaseAdminSummaryAddEditMainScriptNameDescription' => 'Script for this showcase. Default: <code>showcase.php</code>.',
    'myShowcaseAdminSummaryAddEditMainFieldSetId' => 'Field Set',
    'myShowcaseAdminSummaryAddEditMainFieldSetIdDescription' => 'Field set used to define the showcase data table. This cannot be changed after creating the data table.',
    'myShowcaseAdminSummaryAddEditMainRelativePath' => 'Relative Path',
    'myShowcaseAdminSummaryAddEditMainRelativePathDescription' => 'This is path from the forum index page to the showcase. (empty is okay if file is in same folder as forum).',
    'myShowcaseAdminSummaryAddEditMainDisplayOrder' => 'Display Order',
    'myShowcaseAdminSummaryAddEditMainDisplayOrderDescription' => 'The display and build order for this showcase.',
    'myShowcaseAdminSummaryAddEditMainEnabled' => 'Enabled',
    'myShowcaseAdminSummaryAddEditMainEnabledDescription' => 'Enable or disable this showcase.',
    'myShowcaseAdminSummaryAddEditMainCustomThemeTemplatePrefix' => 'Theme Template Prefix',
    'myShowcaseAdminSummaryAddEditMainCustomThemeTemplatePrefixDescription' => 'Template prefix to fetch custom templates.',
    'myShowcaseAdminSummaryAddEditMainOrderDefaultField' => 'Entries Order Default Field',
    'myShowcaseAdminSummaryAddEditMainOrderDefaultFieldDescription' => 'Order entries in the main page using a default field.',
    'myShowcaseAdminSummaryAddEditMainFilterDefaultField' => 'Force Default Filter',
    'myShowcaseAdminSummaryAddEditMainFilterDefaultFieldDescription' => 'Force a filter field to view entries.',
    'myShowcaseAdminSummaryAddEditMainEntries' => 'Entries Options',
    'myShowcaseAdminSummaryAddEditMainEntriesPerPage' => 'Entries Per Page',
    'myShowcaseAdminSummaryAddEditMainEntriesPerPageDescription' => 'The amount of entries to display per page.',

    'myShowcaseAdminSummaryAddEditOtherParser' => 'Parser Options',
    ...
    'myShowcaseAdminSummaryAddEditOtherDisplay' => 'Display Options',
    ...
    'myShowcaseAdminSummaryAddEditOtherModeration' => 'Display Options',
    ...
    'myShowcaseAdminSummaryAddEditOtherComments' => 'Comments Options',
    ...
    'myShowcaseAdminSummaryAddEditOtherAttachments' => 'Attachments Options',
